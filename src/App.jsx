        ...
        {tab === "dashboard" && (
          <div id="dashboard-export-area">
            <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
              <button onClick={handleDownloadDashboardPDF} disabled={exportingPDF} style={{ background: "transparent", color: C.gold, border: `1px solid ${C.gold}55`, borderRadius: 8, padding: "7px 14px", fontSize: 12, fontWeight: 600, cursor: exportingPDF ? "default" : "pointer", opacity: exportingPDF ? 0.6 : 1 }}>
